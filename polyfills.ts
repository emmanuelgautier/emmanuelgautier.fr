...
export async function polyfill(locale = '') {
  ...
  if ((Intl.PluralRules as any).polyfilled) {
    ...
    switch (lang) {
      default:
        dataPolyfills.push(
          import(
            /* webpackChunkName: "intl-pluralrules" */ '@formatjs/intl-pluralrules/locale-data/en' as any
          )
        )
        break
      case 'fr':
        dataPolyfills.push(
          import(
            /* webpackChunkName: "intl-pluralrules" */ '@formatjs/intl-pluralrules/locale-data/fr' as any
          )
        )
        break
    }
  ...
  if ((Intl.NumberFormat as any).polyfilled) {
    switch (locale) {
      default:
        dataPolyfills.push(
          import(
            /* webpackChunkName: "intl-numberformat" */ '@formatjs/intl-numberformat/locale-data/en' as any
          )
        )
        break
      case 'fr':
        dataPolyfills.push(
          import(
            /* webpackChunkName: "intl-numberformat" */ '@formatjs/intl-numberformat/locale-data/fr' as any
          )
        )
        break
    }
  ...
  if ((Intl.DateTimeFormat as any).polyfilled) {
    dataPolyfills.push(
      import('@formatjs/intl-datetimeformat/add-all-tz' as any)
    )
    switch (locale) {
      default:
        dataPolyfills.push(
          import(
            /* webpackChunkName: "intl-datetimeformat" */ '@formatjs/intl-datetimeformat/locale-data/en' as any
          )
        )
        break
      case 'fr':
        dataPolyfills.push(
          import(
            /* webpackChunkName: "intl-datetimeformat" */ '@formatjs/intl-datetimeformat/locale-data/fr' as any
          )
        )
        break
    }
  ...
  if ((Intl as any).RelativeTimeFormat.polyfilled) {
    switch (locale) {
      default:
        dataPolyfills.push(
          import(
            /* webpackChunkName: "intl-relativetimeformat" */ '@formatjs/intl-relativetimeformat/locale-data/en' as any
          )
        )
        break
      case 'fr':
        dataPolyfills.push(
          import(
            /* webpackChunkName: "intl-relativetimeformat" */ '@formatjs/intl-relativetimeformat/locale-data/fr' as any
          )
        )
        break
    }
