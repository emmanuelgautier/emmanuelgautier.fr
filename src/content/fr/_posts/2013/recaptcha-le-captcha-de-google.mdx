...
import recaptchaGoogleImg from '../../../../assets/images/recaptcha-google.png'
...
<Image src={recaptchaGoogleImg} alt="recaptcha" />
...
Tout d'abord, téléchargez le [plugin](https://code.google.com/p/recaptcha/downloads/list?q=label:phplib-Latest). Puis, afin d'afficher le
...
<form action="verify.php" method="post">
  ; <?php require_once('recaptchalib.php'); $publickey = "your_public_key"; //
...
<noscript>
  <iframe
    src="https://www.google.com/recaptcha/api/noscript?k=your_public_key"
    height="300"
    width="500"
    frameborder="0"
  ></iframe>
...
Pour voir quel design sont disponibles et aussi comment fabriquer son propre design je vous invite à regarder sur cette [page](https://developers.google.com/recaptcha/docs/display).
...
### Liens connexes
* [site officiel](https://www.google.com/recaptcha/about/)
