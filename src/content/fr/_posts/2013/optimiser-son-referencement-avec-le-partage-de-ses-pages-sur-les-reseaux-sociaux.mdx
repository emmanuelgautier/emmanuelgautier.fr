...
import optimiserPartageSocial1Img from '../../../../assets/images/optimiser-partage-social-1.jpg'
import optimiserPartageSocial2Img from '../../../../assets/images/optimiser-partage-social-2.jpg'
...
<Image src={optimiserPartageSocial1Img} alt="Sans optimisations pour le partage" />
<Image src={optimiserPartageSocial2Img} alt="Avec optimisations pour le partage" />
...
Pour ce faire, une documentation existe sur le site officiel d'[Open Graph](https://ogp.me/). Vous pouvez de même tester vos pages à ce [lien](https://developers.facebook.com/tools/debug/) sur le site de Facebook.
...
>
  <head>
    ...
    <meta
      property="og:url"
      content="https://www.emmanuelgautier.fr/blog/connaitre-le-nombre-de-partage-de-ses-pages-en-javascript"
    />
    ...
    <meta
      property="og:image"
      content="https://www.emmanuelgautier.fr/images/share-count-javascript.jpg"
    />
