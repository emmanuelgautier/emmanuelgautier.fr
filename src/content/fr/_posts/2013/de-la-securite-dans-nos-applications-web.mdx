...
import securiteWeb1Img from '../../../../assets/images/securite-web1.jpg'
import securiteWeb2Img from '../../../../assets/images/securite-web2.jpg'
import securiteWeb4Img from '../../../../assets/images/securite-web4.jpg'
import securiteWeb5Img from '../../../../assets/images/securite-web5.jpg'
import securiteWeb6Img from '../../../../assets/images/securite-web6.jpg'
import securiteWeb10Img from '../../../../assets/images/securite-web10.jpg'
import securiteWeb11Img from '../../../../assets/images/securite-web11.jpg'
...
Exemple :
<Image src={securiteWeb1Img} alt="attaque xss" />
<Image src={securiteWeb2Img} alt="attaque xss" />
...
**Exemple**
<Image src={securiteWeb4Img} alt="injection sql" />
<Image src={securiteWeb5Img} alt="injection sql" />
...
<Image src={securiteWeb6Img} alt="script contenant la faille include" />
...
<html>
  ...
  <body>
    <?php if (!empty($_GET['q'])) { include($_GET['q']); } ?>
  </body>
</html>
```
...
<Image src={securiteWeb10Img} alt="erreur php" />
...
<Image src={securiteWeb11Img} alt="script sécurisé contre la faille include" />
