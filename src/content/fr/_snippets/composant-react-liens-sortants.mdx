...
description: Dans cet article, je vais vous montrer comment créer un composant React personnalisé pour les liens sortants qui inclut les attributs spécifiques répondant aux différentes problèmatiques de référencement, tels que rel="noopener noreferrer" et target="_blank".
