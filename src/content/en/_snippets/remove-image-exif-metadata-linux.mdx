---
title: Removing Exif Data from an Image on Linux using exiftool
description: you can use the exiftool command line tool to remove Exif data from an image on Linux. Here's how you can use it.
image: ../../../assets/images/linux.png
slug: remove-image-exif-metadata-linux
alternate:
  fr: supprimer-donnees-exif-image-linux
tags:
  - linux
locale: en
