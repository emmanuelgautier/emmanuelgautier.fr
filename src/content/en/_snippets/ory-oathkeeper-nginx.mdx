...
description: Learn how to secure your API gateway by configuring Nginx with OAuthkeeper for API proxy authentication. This blog post will show you configure Nginx and OAuthkeeper to ensure that only authenticated users or applications can access your APIs.
image: ../../../assets/images/ory.png
