...
updated: 2022-03-19T22:13:33.922Z
...
Development of a product implies a lot of roles. Here is a list of the most important roles:
- Backend Developer: A developer who is in charge of the backend part of the software.
- Frontend Developer: A developer who is in charge of the frontend part of the software, mostly the UI/UX integration part.
- Fullstack Developer: It is quite an umbrella term for both backend and frontend development. The fullstack developer usually works on all the parts of the software from the frontend to the backend part.
  Site Reliability Engineer (SRE): An engineer is responsible for making the service up and running with the best quality of service possible for the product users.
- QA Enginner : A developer who is in charge of the quality of the software. Depending the company, he can make the quality assurance or help developers to put in place the quality into their development cycle. -->
  <!-- UX/UI Designer :
  Product Owner :
  Software Architect:
  Solutions Architect:
...
<!-- TODO: Talk about languages, libraries, frameworks, ... -->

<!-- TODO: What is Open Source? -->
<!-- TODO: Code License -->
