...
description: Apple ARM M1 issue is that number of software are not compatible with the microarchitecture ARMv8 like MySQL official Docker image for example. Here a solution.
...
updated: '2022-02-26T16:26:12.054Z'
...
To be able to use MySQL official Docker image on Mac with M1 CPU, you need to use the `arm64v8/mysql` image instead. More tags are available on the official [Docker Hub repository](https://hub.docker.com/r/arm64v8/mysql/tags).
