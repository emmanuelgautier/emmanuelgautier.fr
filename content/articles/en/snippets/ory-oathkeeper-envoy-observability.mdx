---
name: Ory OAthKeeper with Envoy Proxy, Prometheus and Jaeger Docker Compose
description:
...
image:
  contentUrl: /images/ory.png
identifier: ory-oathkeeper-envoy-observability
keywords:
  - oathkeeper
  - envoy
  - observability
...
inLanguage: en
isPartOf: snippets
dateModified: 2023-01-23T22:38:03.162Z
dateCreated: 2023-01-23T22:38:03.162Z
---
...
services:
  ...
  prometheus:
    image:
  contentUrl: prom/prometheus:v2.12.0
    ports:
      - "9090:9090"
    depends_on:
      - oathkeeper
  ...
  jaeger:
    image:
  contentUrl: jaegertracing/all-in-one
  ...
  envoy:
    image:
  contentUrl: envoyproxy/envoy:v1.25-latest
    ports:
      - "8081:8081"
    depends_on:
      - oathkeeper
