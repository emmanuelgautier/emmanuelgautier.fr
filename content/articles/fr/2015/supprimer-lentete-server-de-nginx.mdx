---
name: Supprimer l’entête server de Nginx
...
keywords:
  - linux
  - nginx
identifier: supprimer-lentete-server-de-nginx
inLanguage: fr
isPartOf: blog
